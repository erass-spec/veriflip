 ...
 * neon rings, ticked coin edge, depth highlight, and an etched symbol.
 * Shared by the landing hero coin and the in-game flip coin.
 */
export default function TokenFace({ v }: { v: "heads" | "tails" }) {
