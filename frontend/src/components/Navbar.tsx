...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-3 z-50 mb-6 flex items-center justify-between gap-3 rounded-2xl border border-white/10 bg-slate-950/80 px-4 py-3 shadow-lg backdrop-blur-md">
