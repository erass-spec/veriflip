          ...
          <AnimatePresence initial={false}>
            {games.map((g) => (
              <motion.button
                ...
                exit={{ opacity: 0 }}
                transition={{ duration: 0.4, backgroundColor: { duration: 1, ease: "easeOut" } }}
                onClick={() => onSelect?.(g)}
                className="flex w-full items-center gap-2.5 border-b border-white/5 px-4 py-2.5 text-left text-xs"
              >
